...
x = 0
global_var = 1 # global je keyword, tak jest jiz ma sve vlastni nadrizene vyuziti v jazyce python, ktere nemuzeme prevzit pod sebe.
PI = 3.14
city = "Opava"
hilda_sspu_opava_cz = 'Hilda Dokonalá' # Nesmime pouzivat specialni znaky jako jsou treba @%$-, etc...
password2 = 'TajneHeslo'
agent007 = 'James Bond' # Nesmime nikdy zacinat cislem..
